...
requireText(loot, "local function orbTargetBatchSize()", "orb target batch sizing");
requireText(loot, "local function orbMaxHoldSeconds()", "orb minimum hold window");
requireText(loot, "run.OrbHeldForBatch = run.OrbHeldForBatch + 1", "small orb batches are held instead of flushed immediately");
...
requireText(main, 'return true, "bounded P3 background slot"', "P3 automation cannot starve behind farm/loot telemetry");
