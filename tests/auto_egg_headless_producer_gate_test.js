...
requireText('local MODULE_VERSION = "1.5.4"',
...
console.log("Auto egg headless producer gate OK | native visuals suppressed before allocation | native mode preserved");
