...
assert(protected(rainbow, { powers = { { "Rainbow Coins", 4 } } }) == true)
assert(protected(rainbow, { powers = { { "Rainbow Coins", 3 } } }) == false)
assert(protected(rainbow, { Powers = { ["Rainbow Coins"] = "IV" } }) == true)
assert(protected(rainbow, { powers = { "Rainbow Coins V" } }) == true)

assert(protected(darkMatter, { powers = { { "Rainbow Coins", 4 } } }) == true)
assert(protected(darkMatter, { powers = { { "Rainbow Coins", 3 } } }) == false)
...
print("PASS Hellish Axolotl Rainbow Coins protection formats")
