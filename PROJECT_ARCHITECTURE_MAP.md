...
В Different mode allocator выбирает target с минимальной текущей нагрузкой и использует стабильное смещение на основе `UserId`, чтобы несколько аккаунтов не перескакивали синхронно на один ID.
...
| Diamond pack | threshold, не чаще 180s | Toggle on | Только threshold |
